...
from mongo_consumer_app.repository.students_repository import insert_student, insert_life_style, insert_performance, \
    insert_review, insert_teacher, insert_class, insert_relationship
